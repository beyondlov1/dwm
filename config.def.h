...
static const char *querycmd[] = {"~/software/queryclip.sh", "http://bing.com?q=%s", NULL};
static const char *dictcmd[] = {"~software/queryclip.sh", "http://youdao.com?word=%s&lang=en", NULL};
