...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,                       XK_Right,      expand,       {.f = 0.2} },
	{ MODKEY|ControlMask,                       XK_Left,      expand,       {.f = -0.2} },
	 { MODKEY|ControlMask,                       XK_j,      expand,       {.f = 0.2} },
	{ MODKEY|ControlMask,                       XK_k,      expand,       {.f = -0.2} },
	 { MODKEY|ControlMask,                       XK_Down,      expand,       {.f = 0.2} },
	{ MODKEY|ControlMask,                       XK_Up,      expand,       {.f = -0.2} },
	...
	{ MODKEY|ShiftMask,             XK_space,  tile5toggleshift, {0} },
